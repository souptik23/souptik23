...
<img src="https://capsule-render.vercel.app/api?type=waving&height=280&color=gradient&text=Souptik%20Karan&fontColor=ffffff&fontAlign=50&fontAlignY=38&desc=Full%20Stack%20Java%20Developer%20|%20Building%20the%20Future&descAlignY=55&animation=fadeIn&descSize=20" />

<img src="https://readme-typing-svg.herokuapp.com?font=Inter&weight=600&size=24&duration=4000&pause=1000&color=64FFDA&center=true&vCenter=true&width=800&lines=🚀+Spring+Boot+%7C+React+%7C+Microservices;🤖+AI+%26+LLM+Integrations+with+Gemini+API;⚙️+Docker+%7C+Kubernetes+%7C+CI/CD;🧠+Scalable+Backend+Architectures;🎯+Building+the+Future,+One+Commit+at+a+Time!" />
